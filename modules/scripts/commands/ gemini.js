...
module.exports.config = {
  ...
  version: "1.0",
  category: "ai",
  description: "Get answers from the ai (blackbox-gemini).",
  adminOnly: false,
  usePrefix: true,
  cooldown: 5,
};
...
module.exports.run = function ({ event, args }) {
  ...
  axios
    .get(`https://api.kenliejugarap.com/blackbox-gemini/?text=${encodeURIComponent(question)}`)
    .then((response) => {
